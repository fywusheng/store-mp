  ...
  <view class="point">
    ...
    <view class="_c">
      <view class="use">
        ...
        <view class="_right">
          <view class="j" @click="goHandler">{{
            userInfo.tel ? "赚取积分" : "去登录"
          }}</view>
        </view>
      </view>
      <view class="di_kou">
        ...
        >
          <view class="_n_list">
            ...
            <view class="list_r">
              <view
                class="_n"
                :class="{ turnColor: v.soldOut === 0 ? true : false }"
                >{{ v.name }}</view
              >
              <view class="line">
      ...
      <view class="recommed">
        ...
        >
          ...
          <view class="_p">
            ...
            ￥{{
              v.isCreditPoints == 1 && (v.presentPrice || v.presentPrice == 0)
                ? v.presentPrice
                : ""
            }}
          </view>
