  ...
  <view class="my-points">
    ...
    <view class="card br-16 bg-white m-0-32 p-24 flex-v">
      ...
      <view class="flex-h flex-c-s">
        ...
        <text class="fs-36 c-secondary ml-12" @click="handleScoreList"
          >查看</text
        >
      </view>
      ...
      <view class="progress-bar mt-16">
        ...
        <view
          class="current br-6 animated"
          :style="{ width: progressBarWidth + 'rpx' }"
        />
      </view>
    ...
    <view class="points-detail bg-white">
      <view class="tab-bar flex-h flex-c-s">
        <view style="font-size: 44rpx; color: #333333; font-weight: bold"
          >赚积分</view
        >
        <!-- <button
          class="tab animated"
      ...
      <view class="list" v-if="selectedIndex === 0">
        ...
        >
          ...
          <view class="info flex-v m-0-24 flex-1">
            ...
            <text class="fs-36 c-primary mt-12"
              >+{{ item.taskScore }} 积分</text
            >
          </view>
  ...
  methods: {
    ...
    async succFlag(flag) {
      if (flag == 1) {
        ...
        uni.navigateTo({
          url: `/pages/user-center/real-name-result2?back=${
            urls[this.clickId]
          }`,
        });
      }
    ...
    selectUrl(item) {
      ...
      if (this.userInfo.crtfStas !== "2") {
        ...
        if (tastId == "6") {
          this.headImg =
            "https://ggllstatic.hpgjzlinfo.com/static/common/loginAttest.png";
        } else {
          this.headImg =
