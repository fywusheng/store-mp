<template>
  <view class="register-result flex-v flex-c-s">
    ...
    <button class="button button-1 fs-44 fw-bold c-white mt-128" hover-class="none"
      @click="handleApplyClick">
      立即领取
    </button>
    <button class="button button-2 fs-44 c-primary mt-32 bg-white" hover-class="none"
