  ...
  <view class="pay-detail">
    ...
    <view class="page-header mt-16">
      <view class="account-info">
        ...
        <view class="order-account"
          >¥{{ formaterMoney(formData.payAmount) }}</view
        >
      </view>
      <view class="order-info">
        ...
        <view class="list-item">
          ...
          <view class="content" @click="handlePayWayPop">
            ...
            <view
              >{{ payCardInfo.bankName }}({{
                payCardInfo.encryptCardNum
              }})</view
            >
  ...
  methods: {
    ...
    handleNavBack() {
      if (this.formData.orderSource === 0) {
        ...
        const url =
          "https://ggll.hpgjzlinfo.com/#/checkstand?cashId=" +
          this.formData.cashId;
        uni.navigateTo({
