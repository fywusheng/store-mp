		...
		<view class="content">
			...
			<view class="info_content flex_r_h">
				<view class="row flex_r_h" @click="exportOrderInfo(40)">
					<image src="https://ggllstatic.hpgjzlinfo.com/static/store-mp/dc-icon.png" mode="widthFix"
						class="icon"></image>
					<view class="desc">
						<view>导出已完成</view>
						<view>订单列表</view>
				...
				<view class="row flex_r_h" @click="exportOrderInfo(100)">
					<image src="https://ggllstatic.hpgjzlinfo.com/static/store-mp/dcq-icon.png" mode="widthFix"
						class="icon"></image>
					<view class="desc">
						<view>导出已退款</view>
						<view>订单列表</view>
				...
				<view class="row flex_r_h" @click="exportOrderDetail(40)">
					<image src="https://ggllstatic.hpgjzlinfo.com/static/store-mp/mx-icon.png" mode="widthFix"
						class="icon"></image>
					<view class="desc">
						<view>导出已完成</view>
						<view>订单明细</view>
				...
				<view class="row flex_r_h" @click="exportOrderDetail(100)">
					<image src="https://ggllstatic.hpgjzlinfo.com/static/store-mp/dct-icon.png" mode="widthFix"
						class="icon"></image>
					<view class="desc">
						<view>导出已退款</view>
						<view>订单明细</view>
