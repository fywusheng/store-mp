<template>
  <div class="page-service-type">
    ...
    <ul v-if="dataForm.returnsType==2&&dataForm.goodsState === 2&&dataForm.returnsStatus>=0"
      class="info-list">
      <li class="info">
    ...
    <div class="btn-submit"
      v-if="dataForm.returnsStatus!=-3&&(dataForm.returnsStatus<1&&dataForm.expressStatus==0)"
      @click="cancel">取消</div>
    <div class="btn-submit" v-if="dataForm.returnsStatus==0&&dataForm.expressStatus==0"
      @click="save">提交</div>
  </div>
</template>
