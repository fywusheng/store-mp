...
export default {
  ...
  computed: {
    ...
    // 密码图标地址
    passwordIconURL() {
      return this.showsPasswordText ? 'http://192.168.1.187:10088/static/user-center/icon-user-center-show-password.png' : 'http://192.168.1.187:10088/static/user-center/icon-user-center-hide-password.png'
    }
  },
  onLoad(e) {
    if (e.goUrl) {
